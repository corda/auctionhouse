...
//    /**
//     * Task 1.
//     * The first task is to grab the [AuctionState] for the given [linearId] from the vault, assemble a transaction
//     * and sign it.
...
//        val flow = AuctionSettleFlow(inputIou.linearId, 5.POUNDS)
//        val future = a.startFlow(flow)
//        mockNetwork.runNetwork()
